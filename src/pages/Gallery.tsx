...
const galleryItems = [
  ...
  { id: 2, category: 'Diskusi', img: musyawarahOwnerImg, title: 'Musyawarah Owner & Founder' },
  { id: 3, category: 'Persaudaraan', img: zalzalahSupportImg, title: 'Zalzalah Support Session' },
  { id: 4, category: 'Rihlah', img: rihlahPengusahaImg, title: 'Rihlah Pengusaha Berkah' },
  { id: 5, category: 'Kajian', img: klinikMuamalahImg, title: 'Klinik Muamalah' },
